              ...
              ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    if(status.isGranted){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Image Downloading'),));
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        text,
                        style: Theme.of(context).textTheme.bodyText1?.copyWith(
                            color: isSenderMyUser ? Colors.white : Colors.black,
              ...
              children: [
                Padding(
                    ...
                    child:  GestureDetector(
                      ...
                      child: Column(
                        children: [
                          SvgPicture.asset('assets/icons/pdf.svg',height: 50,),
                         SizedBox(height: 5,),
                         // Icon(Icons.document_scanner_outlined,size: 50,),
                          Text('View PDF',style: TextStyle(fontWeight: FontWeight.bold),)
                        ],
                      ),
                    ),
