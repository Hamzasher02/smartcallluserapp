        ...
        appBar: AppBar(
          ...
          actions: [
           // CallWithTime(id: widget.otherUserId, name: widget.otherUserName, height: 40, width:50, video: false,),
            CallWithTime(id: widget.otherUserId, name: widget.otherUserName, height: 40, width:50, video: true,),
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        print(formattedDate);
                        formattedDate == formattedDate ? const Text('hello',style: TextStyle(color: Colors.black),) : null;
                        return ListTile(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    suffixIcon: IconButton(
                      icon: const Icon(Icons.attach_file,color: Color(0xff607d8b),),
